                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                          ...
                          <a href="https://poocoin.app/tokens/0x9096690B77d7f694Ba784B95576594df6c3b0055" class="btn btn-lg btn-gradient-blue btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="margin-left: 25px;">CHART</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 text-center">
                ...
                <div style="margin-bottom:15px;">
                    ...
                    <h4 style="font-size:24px">1 BNB + 96% Total Supply</h4>
                </div>
            </div>
        </div>
    </div>
