                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                            <a href="https://poocoin.app/tokens/0xc7240A8dE090F582C24A96ECb3948D288766C9E4" class="btn btn-lg btn-gradient-purple btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="background:#0047ab;margin-left: 25px">Chart</a>
                            <a href="https://exchange.pancakeswap.finance/#/swap?inputCurrency=0xc7240A8dE090F582C24A96ECb3948D288766C9E4" class="btn btn-lg btn-gradient-purple btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="background:#0047ab;margin-left: 25px">Buy Token</a>
        ...
        <div class="row">
            <div class="col-md-4 col-lg-4" style="border:solid;padding:20px">
                <div style="margin-bottom:15px;">
                    <h3 style="font-size:25px" class="text-center">BUY FEES | 8%</h3>
                    <ul style="margin-top:20px; font-size: 17px">
                        <li>
                          <span class="fa fa-check" style="color:blue"></span> Marketing 4%
                        </li>
                        <li style="margin-top:10px">
                          <span class="fa fa-check" style="color:blue"></span> Development 2%
                        </li>
                        <li style="margin-top:10px">
            ...
            <div class="col-md-4 col-lg-4" style="border:solid;padding:20px">
                <div style="margin-bottom:15px;">
                    <h3 style="font-size:25px" class="text-center">SELL FEES | 8%</h3>
                    <ul style="margin-top:20px; font-size: 17px">
                        <li>
                          <span class="fa fa-check" style="color:blue"></span> Marketing 4%
                        </li>
            ...
            <div class="col-md-4 col-lg-4" style="border:solid;padding:20px">
                <div style="margin-bottom:15px;">
                    ...
                    <ul style="margin-top:20px; font-size: 17px">
                        ...
                        <li style="margin-top:10px">
                          <span class="fa fa-check" style="color:blue"></span> Anti Whale | Max Wallet 1%
                        </li>
                        <li style="margin-top:10px">
                          <span class="fa fa-check" style="color:blue"></span> Anti Dump | Max Tx 1%
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row text-center" style="margin-top:20px">
            <div class="col-md-12 col-lg-12">
              <ul style="margin-top:20px; font-size: 17px">
                  ...
                  <li style="margin-top:10px">
                    <span class="fa fa-table-columns" style="color:blue"></span> Initial Liquidity Pool : 7 BNB
                  </li>
              </ul>
            </div>
        </div>
