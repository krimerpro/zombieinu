                    ...
                    <div class="banner-content">
                      <div id="svg-animation">
                        ...
                        <div class="mt-5 text-center">
                            <a href="https://poocoin.app/tokens/0x3dcc9304c0d6cACFB9B545Ff777Aa6FfB4EEFDea" class="btn btn-lg btn-gradient-purple btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="background:#0047ab;margin-left: 25px">Chart</a>
                            <a href="https://exchange.pancakeswap.finance/#/swap?inputCurrency=0x3dcc9304c0d6cACFB9B545Ff777Aa6FfB4EEFDea" class="btn btn-lg btn-gradient-purple btn-glow mb-2 animated" target="_blank" data-animation="fadeInUpShorter" data-animation-delay="1.8s" style="background:#0047ab;margin-left: 25px">Buy Token</a>
